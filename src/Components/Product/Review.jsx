...
const Review = () => {
  return (
    <div className="w-[1151px] h-[520px] bg-[#FFFFFF] border border-solid border-[#C2C2C2] relative">
      ...
      <div className="absolute top-[78px] left-[50px] ">
        <div className="w-[1051px] h-[124px] flex border-b-2 border-[#D8D8D8]">
        <img
          src={Avatar}
          alt=""
        ...
        <div>
          ...
          <Stars />
          <p className="font-normal font-roboto text-[14px] mt-[5px] w-[947px] h-[38.37px] leading-[16.41px]">
          ...
          <p className="w-[73px] h-[14px]font-roboto font-bold text-[#5A5A5A] text-[12px] ">
            27 May, 2018
          </p>
        </div>
        </div>
    ...
    <div className="absolute top-[469px] left-[460px]">
        <PaginationComponent />
    </div>
